...
- **[Aegis-DevOps](https://github.com/moneytool/aegis-devops)** - Checks an agent's kubectl, Terraform, cloud CLI and SQL commands before execution, rejecting policy rules that were tampered with or came from an unauthorized source.
